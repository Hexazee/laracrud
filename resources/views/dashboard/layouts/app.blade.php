...
<body class="antialiased bg-gray-600">
    <!-- content -->
    <div class="lg:grid grid-cols-5 lg:mt-20">
        <div class="col-span-1">
            <!-- sidebar -->
            <nav class="col-span-1 -mt-20 tranform -translate-x-full lg:translate-x-0 fixed bg-gray-900 lg:bg-gray-900/60 text-gray-100 px-14 py-2 min-h-screen lg:block z-20" :class="{'translate-x-0 transform transition duration-300 ease-in':open === true, '-translate-x-full transform transition duration-300 ease-out':open === false}">
        ...
        <div class="lg:grid col-span-5 lg:col-span-4">
            <div class="lg:ml-[17rem] w-full lg:w-0 lg:absolute top-0 left-0">
                <!-- navbar -->
