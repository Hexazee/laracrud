...
@section('content')
    ...
    @if(session()->has('success'))
        <h4 class="bg-gray-100 text-green-600 p-2 rounded overflow-hidden">{{ session('success') }}</h4>
    @endif
                ...
                <tr class="{{ $loop->iteration % 2 == 0 ? 'bg-gray-500' : '' }}">
                    ...
                    <td class="flex items-center justify-center flex-col lg:flex-row space-y-1 py-3">
                        <div class="flex items-center space-x-1">
                            ...
                            <a href="" class="p-1 rounded-md hover:shadow-lg bg-yellow-400">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                  </svg>
                            </a>
                            <a href="" class="p-1 rounded-md hover:shadow-lg bg-red-700">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
