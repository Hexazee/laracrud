    ...
    <div class="mt-5">
        ...
        <form action="/dashboard/posts/{{ $post->slug }}" method="post" class="w-full lg:w-2/3">
            ...
            <div class="flex flex-col">
                ...
                <input type="text" class="px-4 py-2 rounded-md w-full focus:outline-none focus:ring focus:ring-sky-400 @error('title') ring ring-red-600 @enderror" id="title" name="title" autofocus value="{{ old('title', $post->title) }}">
                @error('title')
