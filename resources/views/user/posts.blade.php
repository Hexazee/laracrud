...
@section('content')
<header class="container mt-5 text-center md:mx-0">
    <h1 class="text-2xl text-gray-300 underline decoration-sky-400">{{ $author }}</h1>
    <h2 class="text-xl text-gray-400">{{ $job }}</h2>
</header>
